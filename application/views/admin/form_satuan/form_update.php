...
<head>
  ...
  <title>Go-Edang | Tambah Stok</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-mini"><b>GO</b>E</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>GO</b>-EDANG</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?= base_url('admin')?>">
            <i class="fa fa-dashboard"></i> <span>Rekapitulasi</span>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
			<li class ="active"><a href="<?= base_url('admin/tabel_stokbarang')?>"><i class="fa fa-circle-o"></i> Tabel Stok Barang</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tabel Stok Barang</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/tambah_stok')?>" role="form" method="post">
				...
				<div class="form-group">
                  ...
                  <input type="text" name="tanggal" style="margin-left:66px;width:20%;display:inline;" class="form-control form_datetime" placeholder="Klik Disini">
                      ...
                      <div class="form-group" style="display:inline-block;">
                        ...
                        <label for="id_barang" style="width:87%;margin-left: 12px;">Kode Barang</label>
                        <input type="text" required name="id_barang" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control"readonly="readonly" id="id_barang" placeholder="Kode Barang" value="<?=$d->id_barang?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_barang" style="width:73%;">Nama Barang</label>
                        <input type="text" required name="nama_barang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_satuan" readonly="readonly" placeholder="Nama Satuan" value="<?=$d->nama_barang?>">
                    </div>
					<div class="form-group" style="display:inline-block;">
                        <label for="jumlah" style="width:73%;">Jumlah Stok</label>
                        <input type="number" required name="jumlah" style="width:90%;margin-right: 67px;" class="form-control" id="jumlah" placeholder="Jumlah Stok">
                    </div>
                    <div class="form-group" style="display:inline-block;">
                    ...
                    <div class="box-footer" style="width:93%;">
                      ...
                      <button type="submit" style="width:20%;margin-left:40%" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Submit</button>
                    </div>
            </form>
          </div>
          </div>
