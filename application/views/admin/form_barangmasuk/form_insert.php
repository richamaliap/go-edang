...
<head>
  ...
  <title>Go-Edang | Data Barang Masuk</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
		  <li><a href="<?= base_url('admin/tabel_stokbarang')?>"><i class="fa fa-circle-o"></i> Tabel Stok Barang</a></li>
            ...
            <?php } ?>
              ...
              <div class="box-body">
				...
				<?php foreach ($list_gudang as $gd){
                    echo "<option value='".$gd['id_gudang']."'>".$gd['lokasi']."</option>";
				}?>
                  </select>
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="kode_barang" style="width:60%;margin-left: 12px;">Kode Barang</label>
               ...
               <div class="form-group" style="display:inline-block;">
                  <label for="merk" style="width:73%;">Merk</label>
                  <input type="text" name="merk" style="width:90%;margin-right: 67px;" class="form-control" id="merk" placeholder="Merk">
              </div>
			  <div class="form-group" style="display:inline-block;">
                  <label for="tipe" style="width:73%;">Tipe</label>
                  <input type="text" name="tipe" style="width:90%;margin-right: 67px;" class="form-control" id="tipe" placeholder="Tipe">
              </div>
              <div class="form-group" style="display:inline-block;">
                <label for="jumlah" style="width:73%;margin-left:11px;">Jumlah</label>
                <input type="number" name="jumlah" style="width:41%;margin-left:11px;margin-right:18px;" class="form-control" id="jumlah">
            </div>
            <div class="form-group" style="display:inline-block;">
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" class="btn btn-info" style="width:14%;margin-right:29%" href="<?=base_url('admin/tabel_stokbarang')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Barang</a>
