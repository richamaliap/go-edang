...
*/
  public function barangKeluar()
  {
    ...
    //$ls   = array('id_transaksi' => $id ,'tanggal' => $tgl1.'/'.$tgl2.'/'.$tgl3);
	
    $data = $this->M_admin->getInvoiceKeluar($id);
//var_dump($data);
    $pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
    ...
    //header Data
    $pdf->SetHeaderData('dts.png',50,'Laporan Data','Barang Keluar',array(203, 58, 44),array(0, 0, 0));
    $pdf->SetFooterData(array(255, 255, 255), array(255, 255, 255));
      ...
      '<div>
        ...
        <table border="1">
          <tr>
            ...
            <th style="width:130px" align="center">Lokasi Tujuan</th>
            <th style="width:140px" align="center">Kode Barang</th>
            <th style="width:140px" align="center">Nama Barang</th>
            <th style="width:140px" align="center">Merk</th>
          ...
          foreach($data as $d){
            ...
            $html .= '<td align="center">'.$d->jumlah_barang.'</td>';
            $html .= '</tr>';
